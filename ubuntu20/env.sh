...
export UPSTREAM_VERSION=2.13.3
export UPSTREAM_DIR=$GITHUB_WORKSPACE/ubuntu20/openvswitch-${UPSTREAM_VERSION}
export SOURCE_PACKAGE_VERSION=${UPSTREAM_VERSION}-0ubuntu0.20.04.2

# Name of the output directory and tarball
export OUTNAME=ovs-ubuntu20-with-primary-slave-interface
